! function () {
    ...
    window.addEventListener("load", function () {
        for (var i = document.getElementsByClassName("sortable-table"), o = [], s = 0; s < i.length; s++) ! function () {
            ...
            for (var u = i[s].getElementsByTagName("thead")[0].getElementsByTagName("tr")[0].getElementsByClassName("sort_list_alphabetically"), m = 0; m < u.length; m++) ! function () {
                var s = u[m].classList.contains("numeric-sort");
